    ...
    LazyColumn(
        ...
        item {
            ...
            ReplyEmailDetailsCard(
                ...
                modifier = if (isFullScreen) Modifier.padding(horizontal = 16.dp)
...
private fun ReplyEmailDetailsCard(
    ...
    val displayToast = { text: String -> Toast.makeText(context, text, Toast.LENGTH_SHORT).show() }
    Card(
        modifier = modifier,
        ...
        Column(
            ...
            DetailsScreenHeader(email = email)
            if (!isFullScreen) {
                Text(
                    text = email.subject,
            ...
            DetailsScreenButtonBar(mailboxType = mailboxType, displayToast = displayToast)
        }
    }
}
...
private fun ActionButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor =
            if (!containIrreversibleAction) MaterialTheme.colorScheme.inverseOnSurface
        ...
        Text(
            text = text,
            color =
            if (!containIrreversibleAction) MaterialTheme.colorScheme.onSurfaceVariant
